...
As its payloud, the attestation embeds an SBOM in CycloneDX 1.7 format
...
a high-risk vulnerability when they scan this container. As of July 2026,
no vulnerability is reported because `grype` does not find the SBOM.
